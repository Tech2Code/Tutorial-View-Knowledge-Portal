...
<tr><td class="bg"><a class="tab1" target="_top"   href="string.php" >Java - String</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#FF9933 ;font-size:19;">Java - String Class</marquee>
...
<td style="text-align:right;"><a  href="method.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
...
<pre class="output">String greeting = "Hello world!";
</pre>
...
<pre class="output">public class StringDemo
{
...
<p><b>Note:</b> The String class is immutable, so that once it is created a String object cannot be changed. If there is a necessity to make a lot of modifications to Strings of characters, then you should use <a href="http://www.tutorialspoint.com/java/java_string_buffer.htm">String Buffer &amp; String Builder</a> Classes.</p>
<h2>String Length:</h2>
...
<pre class="output">"My name is ".concat("Zara");
</pre>
...
<p>This would produce the following result:</p>
<pre class="output">Dot saw I was Tod
</pre>
