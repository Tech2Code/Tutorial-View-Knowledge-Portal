...
<tr><td class="bg"><a  class="tab1" target="_top"   href="decision.php" >C - Decision Making</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#00f;font-size:18;">C - Decision Making</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\images\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="operator.php"><img src="../images/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="loop.php"><img src="../images/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
...
<center><img src="../images/decision_making.jpg" alt="Decision making statements in C"></center>
...
<tbody><tr><th style="width:35%">Statement</th><th>Description</th></tr>
<tr><td>if statement</td><td>An <b>if statement</b> consists of a boolean expression followed by one or more statements.</td></tr>
<tr><td>if...else statement</td><td>An <b>if statement</b> can be followed by an optional <b>else statement</b>, which executes when the boolean expression is false.</td></tr>
<tr><td>nested if statements</td><td>You can use one <b>if</b> or <b>else if</b> statement inside another <b>if</b> or <b>else if</b> statement(s).</td></tr>
<tr><td>switch statement</td><td>A <b>switch</b> statement allows a variable to be tested for equality against a list of values.</td></tr>
<tr><td>nested switch statements</td><td>You can use one <b>switch</b> statement inside another <b>switch</b> statement(s).</td></tr>
</tbody></table>
<h2>The ? : Operator:</h2>
...
<pre class="output">Exp1 ? Exp2 : Exp3;
</pre>
