...
<tr><td class="bg"><a  class="tab1" target="_top"   href="program.php" >C - Program Structure</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#00f;font-size:18;">C - Program Structure</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\images\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="environment.php"><img src="../images/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="syntax.php"><img src="../images/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>Before we study basic building blocks of the C programming language, let us look a bare minimum C program structure so that we can take it as a reference in upcoming chapters.</p>
...
<li><p>You will be able to see <i>"Hello World"</i> printed on the screen</p></li>
</ol>
<pre class="output">$ gcc hello.c
$ ./a.out
Hello, World!
</pre>
<p>Make sure that gcc compiler is in your path and that you are running it in the directory containing source file hello.c.</p>
