...
<tr><td class="bg"><a  class="tab1" target="_top"   href="type.php">C - Type Casting</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#00f;font-size:18;">C - Type Casting</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\images\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="header.php"><img src="../images/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="error.php"><img src="../images/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p><b>Type casting</b> is a way to convert a variable from one data type  to another data type. For example, if you want to store a long value into a simple integer then you can type cast long to int. You can  convert values from one type to another explicitly using the <b>cast operator</b> as follows:</p>
<pre class="output">(type_name) expression</pre>
...
<pre class="output">>Value of mean : 3.400000
</pre>
...
<p>When the above code is compiled and executed, it produces the following result:</p>
<pre class="output">>Value of sum : 116
</pre>
...
<center><img src="../images/usual_arithmetic_conversion.png" alt="Usual Arithmetic Conversion"></center>
...
<p>When the above code is compiled and executed, it produces the following result:</p>
<pre class="output">>Value of sum : 116.000000
</pre>
<p>Here, it is simple to understand that first c gets converted to integer but because final value is double, so usual arithmetic conversion applies and compiler convert i and c into float and add them yielding a float result.</p>
