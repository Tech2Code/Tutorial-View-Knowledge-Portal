...
<script type="text/javascript">
	...
	function trim(str)
	{
		return str.replace(/^\s+|\s+$/g, "");
			...
			function f1()
			{
				if(document.frm1.t3.value!=document.frm1.t4.value)
				{
...
<div class="text-main">
 <div class="content-left">
	<div class="contct-box"><span class="blue-hd">Change Password</span><br />
    <div class="quote-main" >
        <div class="quote-hd">Change Password</div>
        <div class="form-blue"><span class="form-small-hd">Please enter your details below .</span><br />
<div class="form-query">
 <form action="cha.php"  enctype="multipart/form-data" name="frm1" id="contacts" onsubmit="return check_value();">
    <div class="quote-hd">
...
<div class="form-inner">
          <label for="old"></label>
          <input type="password" placeholder="Old password" name="t2" id="mobile" />
    </div>
<div class="form-inner">
          <label for="new1"></label>
          <input type="password" placeholder="New Password" name="t3" id="email" />
    </div>
<div class="form-inner">
          <label for="new2"></label>
          <input type="password" placeholder="Re-enter Password" name="t4" id="message" />
    </div>
