...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">C++ Functions</marquee>
</td></tr>
...
<td style="text-align:right;"><a  href="number.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
...
<tbody><tr><th width="30%">Call Type</th><th>Description</th></tr>
...
<tr><td> Call by pointer</td><td>This method copies the address of an argument into the formal parameter. Inside the function, the address is used to access the actual argument used in the call. This means that changes made to the parameter affect the argument.</td> </tr>
<tr><td>Call by reference</td><td>This method copies the reference of an argument into the formal parameter. Inside the function, the reference is used to access the actual argument used in the call. This means that changes made to the parameter affect the argument.</td> </tr>
</tbody></table>
...
<pre class="output">Total value is :300
Total value is :120
</pre>
<br>
<hr>
