...
<tr><td class="bg"><a  class="tab1" target="_top"   href="wildcard.php">SQL - Wildcards</a><br/></td></tr>
</table>
</div>
</td>
<td align="left" valign="top" width="800" bgcolor=white style="background:#ffffff url('../pic/emty.gif')">
<table class="chapter" border="0" width="100%" cellspacing="0" cellpadding="0" >
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - Wildcard Operators</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="transaction.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="home.php"><img src="../pic/home.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>We already have discussed SQL <b>LIKE</b> operator, which is used to compare a value to similar values using wildcard operators.</p>
<p>SQL supports following two wildcard operators in conjunction with the LIKE operator:</p>
<table  border='1'class="tab" width=600 height=400>
<tbody><tr><th style="width:30%">Wildcards</th><th style="width:70%">Description</th></tr>
...
<h2>Example:</h2>
<p>Here are number of examples showing WHERE part having different LIKE clause with '%' and '_' operators:</p>
<table  border='1'class="tab" width=600 height=400>
<tbody><tr><th style="width:30%">Statement</th><th style="width:70%">Description</th></tr>
...
<p>Let us take a real example, consider the CUSTOMERS table having the following records:</p>
<pre class="output">
+----+----------+-----+-----------+----------+
...
<p>Following is an example, which would display all the records from CUSTOMERS table where SALARY starts with 200:</p>
<pre class="output">
