...
<tr><td class="bg"><a  class="tab1" target="_top"   href="orderby.php">SQL - Order By</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - ORDER BY Clause</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="topclause.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="groupby.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>

<p>The SQL <b>ORDER BY</b> clause is used to sort the data in ascending or descending order, based on one or more columns. Some database sorts query results in ascending order by default.</p>
<h2>Syntax:</h2>
<p>The basic syntax of ORDER BY clause is as follows:</p>
<pre class="output">SELECT column-list 
FROM table_name 
[WHERE condition] 
[ORDER BY column1, column2, .. columnN] [ASC | DESC];</pre>
<p>You can use more than one column in the ORDER BY clause. Make sure whatever column you are using to sort, that column should be in column-list.</p>
<h2>Example:</h2>
...
+----+----------+-----+-----------+----------+</pre>
<p>Following is an example, which would sort the result in ascending order by NAME and SALARY:</p>
...
|  1 | Ramesh   |  32 | Ahmedabad |  2000.00 |
+----+----------+-----+-----------+----------+</pre>
<p>Following is an example, which would sort the result in descending order by NAME:</p>
<pre class="output">SQL&gt; SELECT * FROM CUSTOMERS
