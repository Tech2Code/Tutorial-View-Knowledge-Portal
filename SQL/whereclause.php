...
<tr><td class="bg"><a  class="tab1" target="_top"   href="whereclause.php">SQL - Where Clause</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - WHERE Clause</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="selectquery.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="andclause.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>WHERE</b> clause is used to specify a condition while fetching the data from single table or joining with multiple tables.</p>
<p>If the given condition is satisfied then only it returns specific value from the table. You would use WHERE clause to filter the records and fetching only necessary records.</p>
<p>The WHERE clause is not only used in SELECT statement, but it is also used in UPDATE, DELETE statement, etc., which we would examine in subsequent chapters.</p>
<h2>Syntax:</h2>
<p>The basic syntax of SELECT statement with WHERE clause is as follows:</p>
<pre class="output">
SELECT column1, column2, columnN 
FROM table_name
WHERE [condition]
</pre>
<p>You can specify a condition using <a href="operators.php">comparison or logical operators</a> like &gt;, &lt;, =, LIKE, NOT, etc. Below examples would make this concept clear.</p>
<h2>Example:</h2>
...
<p>Following is an example which would fetch ID, Name and Salary fields from the CUSTOMERS table where salary is greater than 2000:</p>
<pre class="output">
...
<p>Following is an example, which would fetch ID, Name and Salary fields from the CUSTOMERS table for a customer with name <b>Hardik</b>. Here, it is important to note that all the strings should be given inside single quotes ('') where as numeric values should be given without any quote as in above example:</p>
<pre class="output">
SQL&gt; SELECT ID, NAME, SALARY 
FROM CUSTOMERS
WHERE NAME = 'Hardik';
