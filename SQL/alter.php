...
<tr><td class="bg"><a  class="tab1" target="_top"   href="alter.php">SQL - Alter Command</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - ALTER TABLE Command</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="indexes.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="usingviews.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>ALTER TABLE</b> command is used to add, delete or modify columns in an existing table.</p>
<p>You would also use ALTER TABLE command to add and drop various constraints on a an existing table.</p>
<h2>Syntax:</h2>
<p>The basic syntax of <b>ALTER TABLE</b> to add a new column in an existing table is as follows:</p>
<pre class="output">ALTER TABLE table_name ADD column_name datatype;</pre>
<p>The basic syntax of ALTER TABLE to <b>DROP COLUMN</b> in an existing table is as follows:</p>
<pre class="output">ALTER TABLE table_name DROP COLUMN column_name;</pre>
<p>The basic syntax of ALTER TABLE to change the <b>DATA TYPE</b> of a column in a table is as follows:</p>
<pre class="output">ALTER TABLE table_name MODIFY COLUMN column_name datatype;</pre>
<p>The basic syntax of ALTER TABLE to add a <b>NOT NULL</b> constraint to a column in a table is as follows:</p>
<pre class="output">ALTER TABLE table_name MODIFY column_name datatype NOT NULL;</pre>
<p>The basic syntax of ALTER TABLE to <b>ADD UNIQUE CONSTRAINT</b> to a table is as follows:</p>
<pre class="output">ALTER TABLE table_name 
ADD CONSTRAINT MyUniqueConstraint UNIQUE(column1, column2...);</pre>
<p>The basic syntax of ALTER TABLE to <b>ADD CHECK CONSTRAINT</b> to a table is as follows:</p>
<pre class="output">ALTER TABLE table_name 
ADD CONSTRAINT MyUniqueConstraint CHECK (CONDITION);</pre>
<p>The basic syntax of ALTER TABLE to <b>ADD PRIMARY KEY</b> constraint to a table is as follows:</p>
<pre class="output">ALTER TABLE table_name 
ADD CONSTRAINT MyPrimaryKey PRIMARY KEY (column1, column2...);</pre>
<p>The basic syntax of ALTER TABLE to <b>DROP CONSTRAINT</b> from a table is as follows:</p>
<pre class="output">ALTER TABLE table_name 
DROP CONSTRAINT MyUniqueConstraint;</pre>
<p>If you're using MySQL, the code is as follows:</p>
<pre class="output">ALTER TABLE table_name 
DROP INDEX MyUniqueConstraint;</pre>
<p>The basic syntax of ALTER TABLE to <b>DROP PRIMARY KEY</b> constraint from a table is as follows:</p>
<pre class="output">ALTER TABLE table_name 
DROP CONSTRAINT MyPrimaryKey;</pre>
<p>If you're using MySQL, the code is as follows:</p>
<pre class="output">ALTER TABLE table_name 
...
+----+----------+-----+-----------+----------+</pre>
<p>Following is the example to ADD a new column in an existing table:</p>
<pre class="output">ALTER TABLE CUSTOMERS ADD SEX char(1);</pre>
<p>Now, CUSTOMERS table is changed and following would be output from SELECT statement:</p>
<pre class="output">+----+---------+-----+-----------+----------+------+
...
+----+---------+-----+-----------+----------+------+</pre>
<p>Following is the example to DROP  sex column from existing table:</p>
<pre class="output">ALTER TABLE CUSTOMERS DROP SEX;</pre>
<p>Now, CUSTOMERS table is changed and following would be output from SELECT statement:</p>
<pre class="output">+----+---------+-----+-----------+----------+
| ID | NAME    | AGE | ADDRESS   | SALARY   |
+----+---------+-----+-----------+----------+
