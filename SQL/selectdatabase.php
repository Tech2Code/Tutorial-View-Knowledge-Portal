...
<tr><td class="bg"><a  class="tab1" target="_top"   href="selectdatabase.php">SQL - Select Database</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - SELECT Database, USE Statement</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="ddatabase.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="createtable.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
...
<p>The SQL <b>USE</b> statement is used to select any existing database in SQL schema.</p>
<h2>Syntax:</h2>
<p>Basic syntax of USE statement is as follows:</p>
<pre class="output">USE DatabaseName;</pre>
<p>Always database name should be unique within the RDBMS.</p>
<h2>Example:</h2>
<p>You can check available databases as follows:</p>
...
<p>Now, if you want to work with AMROOD database, then you can execute the following SQL command and start working with AMROOD database:</p>
<pre class="output">SQL&gt; USE AMROOD;</pre>
