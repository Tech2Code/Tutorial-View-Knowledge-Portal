...
<tr><td class="bg"><a  class="tab1" target="_top"   href="andclause.php" >SQL - AND & OR Clauses</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - AND and OR Conjunctive Operators</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="whereclause.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="updatEquery.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>AND</b> and <b>OR</b> operators are used to combine multiple conditions to narrow data in an SQL statement. These two operators are called conjunctive operators.</p>
...
<p>The <b>AND</b> operator allows the existence of multiple conditions in an SQL statement's WHERE clause.</p>
<h2>Syntax:</h2>
<p>The basic syntax of AND operator with WHERE clause is as follows:</p>
<pre class="output">SELECT column1, column2, columnN 
FROM table_name
WHERE [condition1] AND [condition2]...AND [conditionN];
</pre>
<p>You can combine N number of conditions using AND operator. For an action to be taken by the SQL statement, whether it be a transaction or query, all conditions separated by the AND must be TRUE.</p>
<h2>Example:</h2>
...
<p>Following is an example, which would fetch ID, Name and Salary fields from the CUSTOMERS table where salary is greater than 2000 AND age is less tan 25 years:</p>
<pre class="output">SQL&gt; SELECT ID, NAME, SALARY 
FROM CUSTOMERS
...
<h2>Syntax:</h2>
<p>The basic syntax of OR operator with WHERE clause is as follows:</p>
<pre class="output">SELECT column1, column2, columnN 
FROM table_name
WHERE [condition1] OR [condition2]...OR [conditionN]
</pre>
<p>You can combine N number of conditions using OR operator. For an action to be taken by the SQL statement, whether it be a transaction or query, only any ONE of the conditions separated by the OR must be TRUE.</p>
<h2>Example:</h2>
<p>Consider the CUSTOMERS table having the following records:</p>
<pre class="output">+----+----------+-----+-----------+----------+
| ID | NAME     | AGE | ADDRESS   | SALARY   |
...
<p>Following is an example, which would fetch ID, Name and Salary fields from the CUSTOMERS table where salary is greater than 2000 OR age is less tan 25 years:</p>
<pre class="output">SQL&gt; SELECT ID, NAME, SALARY 
FROM CUSTOMERS
