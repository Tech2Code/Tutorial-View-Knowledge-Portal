...
<tr><td class="bg"><a  class="tab1" target="_top"   href="insertquery.php">SQL - Insert Query</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - INSERT Query</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="droptable.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="selectquery.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>INSERT INTO</b> Statement is used to add new rows of data to a table in the database.</p>
<h2>Syntax:</h2>
<p>There are two basic syntaxes of INSERT INTO statement as follows:</p>
<pre class="output">INSERT INTO TABLE_NAME (column1, column2, column3,...columnN)]  
VALUES (value1, value2, value3,...valueN);
</pre>
<p>Here, column1, column2,...columnN are the names of the columns in the table into which you want to insert data.</p>
<p>You may not need to specify the column(s) name in the SQL query if you are adding values for all the columns of the table. But make sure the order of the values is in the same order as the columns in the table. The SQL INSERT INTO syntax would be as follows:</p>
<pre class="output">INSERT INTO TABLE_NAME VALUES (value1,value2,value3,...valueN);
</pre>
<h2>Example:</h2>
<p>Following statements would create six records in CUSTOMERS table:</p>
<pre class="output">INSERT INTO CUSTOMERS (ID,NAME,AGE,ADDRESS,SALARY)
...
<p>You can create a record in CUSTOMERS table using second syntax as follows:</p>
<pre class="output">INSERT INTO CUSTOMERS 
VALUES (7, 'Muffy', 24, 'Indore', 10000.00 );
</pre>
<p>All the above statements would produce the following records in CUSTOMERS table:</p>
<pre class="output">+----+----------+-----+-----------+----------+
...
<p>You can populate data into a table through select statement over another table provided another table has a set of fields, which are required to populate first table. Here is the syntax:</p>
<pre class="output">INSERT INTO first_table_name [(column1, column2, ... columnN)] 
