...
<tr><td class="bg"><a  class="tab1" target="_top"   href="distinct.php">SQL - Distinct Keyword</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - Distinct Keyword</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="groupby.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="constraints.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>DISTINCT</b> keyword is used in conjunction with SELECT statement to eliminate all the duplicate records and fetching only unique records.</p>
...
<h2>Syntax:</h2>
<p>The basic syntax of DISTINCT keyword to eliminate duplicate records is as follows:</p>
...
+----+----------+-----+-----------+----------+</pre>
<p>First, let us see how the following SELECT query returns duplicate salary records:</p>
<pre class="output">SQL&gt; SELECT SALARY FROM CUSTOMERS
     ORDER BY SALARY;</pre>
<p>This would produce the following result where salary 2000 is coming twice which is a duplicate record from the original table.</p>
<pre class="output">+----------+
| SALARY   |
+----------+
|  1500.00 |
...
| 10000.00 |
+----------+</pre>
<p>Now, let us use DISTINCT keyword with the above SELECT query and see the result:</p>
<pre class="output">SQL&gt; SELECT DISTINCT SALARY FROM CUSTOMERS
     ORDER BY SALARY;</pre>
<p>This would produce the following result where we do not have any duplicate entry:</p>
<pre class="output">+----------+
| SALARY   |
+----------+
|  1500.00 |
...
Tutorial View is for learning, training only. We do not warrant the correctness of its content.
  ...
  <div class="w3-name-main">
    ...
    <div class="w3"><strong>Designed by: </div>
  </div>
</div>
</div>
