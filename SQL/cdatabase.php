...
<tr><td class="bg"><a  class="tab1" target="_top"   href="cdatabase.php">SQL - Create Database</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - CREATE Database</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="expressions.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="ddatabase.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>CREATE DATABASE</b> statement is used to create new SQL database.</p>
<h2>Syntax:</h2>
<p>Basic syntax of CREATE DATABASE statement is as follows:</p>
<pre class="output">CREATE DATABASE DatabaseName;</pre>
<p>Always database name should be unique within the RDBMS.</p>
<h2>Example:</h2>
<p>If you want to create new database &lt;testDB&gt;, then CREATE DATABASE statement would be as follows:</p>
<pre class="output">SQL&gt; CREATE DATABASE testDB;</pre>
<p>Make sure you have admin privilege before creating any database. Once a database is created, you can check it in the list of databases as follows:</p>
