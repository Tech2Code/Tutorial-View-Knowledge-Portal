...
<tr><td class="bg"><a  class="tab1" target="_top"   href="alias.php">SQL - Alias Syntax</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - Alias Syntax</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="null.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="indexes.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>You can rename a table or a column temporarily by giving another name known as alias.</p>
<p>The use of table aliases means to rename a table in a particular SQL statement. The renaming is a temporary change and the actual table name does not change in the database.</p>
<p>The column aliases are used to rename a table's columns for the purpose of a particular SQL query.</p>
<h2>Syntax:</h2>
<p>The basic syntax of <b>table</b> alias is as follows:</p>
<pre class="output">SELECT column1, column2....
FROM table_name AS alias_name
WHERE [condition];</pre>
<p>The basic syntax of <b>column</b> alias is as follows:</p>
<pre class="output">SELECT column_name AS alias_name
FROM table_name
WHERE [condition];</pre>
<h2>Example:</h2>
...
+-----+---------------------+-------------+--------+</pre>
<p>Now, following is the usage of <b>table alias</b>:</p>
<pre class="output">SQL&gt; SELECT C.ID, C.NAME, C.AGE, O.AMOUNT 
        FROM CUSTOMERS AS C, ORDERS AS O
        WHERE  C.ID = O.CUSTOMER_ID;</pre>
...
|  4 | Chaitali |  25 |   2060 |
+----+----------+-----+--------+</pre>
<p>Following is the usage of <b>column alias</b>:</p>
<pre class="output">SQL&gt; SELECT  ID AS CUSTOMER_ID, NAME AS CUSTOMER_NAME
     FROM CUSTOMERS
