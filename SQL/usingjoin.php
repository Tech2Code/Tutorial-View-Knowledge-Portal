...
<tr><td class="bg"><a  class="tab1" target="_top"   href="usingjoin.php" >SQL - Using Joins</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - Using Joins</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="constraints.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="union.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>Joins</b> clause is used to combine records from two or more tables in a database. A JOIN is a means for combining fields from two tables by using values common to each.</p>
<p>Consider the following two tables, (a) CUSTOMERS table is as follows:</p>
<pre class="output">
+----+----------+-----+-----------+----------+
...
+----+----------+-----+-----------+----------+</pre>
<p>(b) Another table is ORDERS as follows:</p>
<pre class="output">
+-----+---------------------+-------------+--------+
...
+-----+---------------------+-------------+--------+</pre>
<p>Now, let us join these two tables in our SELECT statement as follows:</p>
<pre class="output">
SQL&gt; SELECT ID, NAME, AGE, AMOUNT
        FROM CUSTOMERS, ORDERS
        WHERE  CUSTOMERS.ID = ORDERS.CUSTOMER_ID;</pre>
...
|  4 | Chaitali |  25 |   2060 |
+----+----------+-----+--------+</pre>
<p>Here, it is noticeable that the join is performed in the WHERE clause. Several operators can be used to join tables, such as =, &lt;, &gt;, &lt;&gt;, &lt;=, &gt;=, !=, BETWEEN, LIKE, and NOT; they can all be used to join tables. However, the most common operator is the equal symbol.</p>
<h2>SQL Join Types:</h2>
<p>There are different types of joins available in SQL:</p>
<ul>
<li><p>INNER JOIN:- returns rows when there is a match in both tables.</p></li>
<li><p>LEFT JOIN:-  returns all rows from the left table, even if there are no matches in the right table.</p></li>
<li><p>RIGHT JOIN:- returns all rows from the right table, even if there are no matches in the left table.</p></li>
<li><p>FULL JOIN:-  returns rows when there is a match in one of the tables.</p></li>
<li><p>SELF JOIN:-  is used to join a table to itself as if the table were two tables, temporarily renaming at least one table in the SQL statement.</p></li>
<li><p>CARTESIAN JOIN:-  returns the Cartesian product of the sets of records from the two or more joined tables.</p></li>
</ul>
