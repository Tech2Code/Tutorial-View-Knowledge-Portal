...
<tr><td class="bg"><a  class="tab1" target="_top"   href="selectquery.php">SQL - Select Query</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - SELECT Query</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="insertquery.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="whereclause.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>SQL <b>SELECT</b> statement is used to fetch the data from a  database table which returns data in the form of result table.  These result tables are called result-sets.</p>
<h2>Syntax:</h2>
<p>The basic syntax of SELECT statement is as follows:</p>
<pre class="output">SELECT column1, column2, columnN FROM table_name;</pre>
...
<pre class="output">SELECT * FROM table_name;</pre>
<h2>Example:</h2>
...
+----+----------+-----+-----------+----------+</pre>
<p>Following is an example, which would fetch ID, Name and Salary fields of the customers available in CUSTOMERS table:</p>
<pre class="output">SQL&gt; SELECT ID, NAME, SALARY FROM CUSTOMERS;</pre>
...
|  7 | Muffy    | 10000.00 |
+----+----------+----------+</pre>
<p>If you want to fetch all the fields of CUSTOMERS table, then use the following query:</p>
<pre class="output">SQL&gt; SELECT * FROM CUSTOMERS;</pre>
<p>This would produce the following result:</p>
<pre class="output">+----+----------+-----+-----------+----------+
| ID | NAME     | AGE | ADDRESS   | SALARY   |
+----+----------+-----+-----------+----------+
