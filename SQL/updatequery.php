...
<tr><td class="bg"><a  class="tab1" target="_top"   href="updatequery.php">SQL - Update Query</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - UPDATE Query</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="andclause.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="deletequery.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>UPDATE</b> Query is used to modify the existing records in a table.</p>
<p>You can use WHERE clause with UPDATE query to update selected rows otherwise all the rows would be affected.</p>
<h2>Syntax:</h2>
<p>The basic syntax of UPDATE query with WHERE clause is as follows:</p>
...
<p>Following is an example, which would update ADDRESS for a customer whose ID is 6:</p>
<pre class="output">SQL&gt; UPDATE CUSTOMERS
SET ADDRESS = 'Pune'
WHERE ID = 6;
</pre>
...
<p>If you want to modify all ADDRESS and SALARY column values in CUSTOMERS table, you do not need to use WHERE clause and UPDATE query would be as follows:</p>
<pre class="output">SQL&gt; UPDATE CUSTOMERS
