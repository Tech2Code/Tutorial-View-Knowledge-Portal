...
<tr><td class="bg"><a  class="tab1" target="_top"   href="union.php" >SQL - Union</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - UNIONS CLAUSE</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="usingjoin.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="null.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>
<p>The SQL <b>UNION</b> clause/operator is used to combine the results of two or more SELECT statements without returning any duplicate rows.</p>
...
<h2>Syntax:</h2>
<p>The basic syntax of <b>UNION</b> is as follows:</p>
<pre class="output">
...
<p>The UNION ALL operator is used to combine the results of two SELECT statements including duplicate rows.</p>
<p>The same rules that apply to UNION apply to the UNION ALL operator.</p>
<h2>Syntax:</h2>
<p>The basic syntax of <b>UNION ALL</b> is as follows:</p>
<pre class="output">
SELECT column1 [, column2 ]
FROM table1 [, table2 ]
[WHERE condition]
...
<ul>
<li><p>SQL  INTERSECT Clause: is used to combine two SELECT statements, but returns rows only from the first SELECT statement that are identical to a row in the second SELECT statement.</p></li>
<li><p>SQL  EXCEPT Clause : combines two SELECT statements and returns rows from the first SELECT statement that are not returned by the second SELECT statement.</p></li>
</ul>
