...
<tr><td class="bg"><a  class="tab1" target="_top"   href="ddatabase.php">SQL - Drop Database</a><br/></td></tr>
...
<tr><td colspan="2"><marquee direction="left" scrolldellay="500" style="color:#996600;font-size:19;">SQL - DROP or DELETE Database</marquee>
</td></tr>
<tr><td colspan="2" align=center>
<img src="..\pic\student.jpg" alt=" My LOGO" align="middle" width="147" height="147"/></tr></td>

<tr>
<td style="text-align:left;"><a  href="cdatabase.php"><img src="../pic/previous1.gif" width=90 height=30/></a></td>
<td style="text-align:right;"><a  href="selectdatabase.php"><img src="../pic/next1.gif" width=90 height=30/></a></td>
</tr>
<tr><td colspan="2">
<hr>

<p>The SQL <b>DROP DATABASE</b> statement is used to drop an existing database in SQL schema.</p>
<h2>Syntax:</h2>
<p>Basic syntax of DROP DATABASE statement is as follows:</p>
<pre class="output">DROP DATABASE DatabaseName;</pre>
<p>Always database name should be unique within the RDBMS.</p>
<h2>Example:</h2>
<p>If you want to delete an existing database &lt;testDB&gt;, then DROP DATABASE statement would be as follows:</p>
<pre class="output">SQL&gt; DROP DATABASE testDB;</pre>
<p><b>NOTE:</b> Be careful before using this operation because by deleting an existing database would result in loss of complete information stored in the database.</p>
<p>Make sure you have admin privilege before dropping any database. Once a database is dropped, you can check it in the list of databases as follows:</p>
<pre class="output">SQL&gt; SHOW DATABASES;
+--------------------+
| Database           |
+--------------------+
| information_schema |
